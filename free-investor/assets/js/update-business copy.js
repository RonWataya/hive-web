...
updateBusinessProfile();   
  ...
  //    const Country = this.querySelector('select[name="country"]').value
      ...
      try {
        const response = await fetch("http://localhost:4000/api/business/create", {
          method: "POST",
          headers: {
...
async function UpdateBusiness() {
  try {
    ...
    const response = await fetch("http://localhost:4000/api/business/update", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
async function DeleteBusiness(){
    ...
    try {
      const response = await fetch(
        "http://localhost:4000/api/business/delete",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
